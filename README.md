...
This FizzBuzz is calculated **from N-1 to 1**. In REPL:
...
For more examples or informations, see [src/Main.purs](https://github.com/matoruru/purescript-typelevel-fizzbuzz/blob/master/src/Main.purs) and [test/Main.purs](https://github.com/matoruru/purescript-typelevel-fizzbuzz/blob/master/test/Main.purs).
